    ...
    <Layout>
      <div className={classes.implement}>
        ...
        <ol className={classes.skills}>
          <li>掌握软件开发相关知识</li>
          <li>掌握关系型数据库(MySQL、SQL Server)相关知识，及 SQL 语句的使用</li>
          <li>熟悉 Windows 系统的安装、操作及维护</li>
          <li>掌握 Linux 操作系统的常用命令</li>
          <li>熟练使用计算机以及 Office 办公软件</li>
          <li>
        ...
        <Line title="自我评价" />
        <div>
          本人积极向上，勤奋好学，吃苦耐劳，能承受工作压力，有高度责任感，有良好的学习能力及强烈的学习欲望，工作认真负责，有耐心，有职业责任感，思维灵活，善于接受新知识，能够接受出差
        </div>
      </div>
    </Layout>
  )
