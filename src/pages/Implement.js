import classes from './Implement.module.css'
      ...
      <div className={classes.implement}>
        ...
        <div className={classes.basicInfo}>
          ...
          <div className={classes.right}>
            ...
            <div>
              个人网站：
              <a href="https://microdaway.github.io/Implement/" target="_blank">
                https://microdaway.github.io/Implement/
              </a>
            </div>
            <div>求职状态：立即到岗</div>
          </div>
        ...
        <ol className={classes.skills}>
          ...
          <li>熟练使用 Office 办公软件</li>
          <li>熟悉前端开发技术，如 HTML、CSS、JavaScript、Vue2 和 Vue3 及其周边的生态</li>
        </ol>
        <Line title="自我评价" />
        <div>
